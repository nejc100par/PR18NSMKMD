...
f = codecs.open("PNL-OSEBE-2010.TXT")
i = open("pnose2010.csv","w")
f.readline()
...
for vrsta in f:
    ...
    if 1<len(vrsta):
        ...
        Povzrocitelj = tab[1].strip() if tab[1].strip()!="" else ""
        Starost = tab[2].strip() if tab[2].strip()!="" else ""
        Spol = tab[3].strip() if tab[3].strip()!="" else ""
        UEStalnegaPrebivalisca = ""#loob[int(tab[4].strip())] if tab[4].strip() !="" else ""
        Drzavljanstvo = tab[4].strip() if tab[4].strip()!=""  else ""
        PoskodbaUdelezenca = tab[5].strip() if tab[5].strip()!="" else ""
        VrstaUdelezenca = tab[6].strip() if tab[6].strip()!="" else ""
        UporabaVarnostnegaPasu = tab[7].strip() if tab[7].strip()!="" else ""
        VozniskiStazVLetih = tab[8].strip().split("-")[0] if tab[8].strip()!="" else "0"
        VozniskiStazVMesecih = tab[8].strip().split("-")[1] if tab[8].strip()!="" else "0"
        VrednostAlkotesta = "0"+tab[9].strip() if tab[9].strip()!="" else "0"
        VrednostStrokovnegaPregleda = "0"+tab[10].strip() if tab[10].strip()!="" else "0"
